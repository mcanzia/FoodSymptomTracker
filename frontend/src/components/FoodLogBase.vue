        ...
        <b-col cols="8">
            <b-card v-for="component in dateLogStore.selectedDateLog.components" :key="component.id">
                ...
                <b-form v-if="component.typeId == 2">
                    ...
                    <b-form-radio-group id="component-radio" :options="component.selectOptions" text-field="text" value-field="value" disabled class="text-center" v-model="component.values"></b-form-radio-group>
                </b-form>
