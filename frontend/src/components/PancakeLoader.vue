<template>
    <div id="cooking">
        <div class="bubble" v-for="index in 5" :key="index"></div>
        <div id="area">
            <div id="sides">
                <div id="pan"></div>
                <div id="handle"></div>
...
:root {
    --anim_time: 2.1s; /* main pan/pancake animation (in seconds) */
    --flatten_deg: 85deg; /* // how round will the pancake be at the top/peak (in deg), affecting general animation though so not really adjustable */
